...
class YogaCard extends StatelessWidget {
  ...
  final YogaList yogaList;
  YogaCard({this.yogaList, this.yogaPlaylist});
  @override
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            child: yogaList.imageUrl.split('.').last == 'svg' ?SvgPicture.network(
              yogaList.imageUrl,
              fit: BoxFit.cover,
          ...
          Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                yogaList.benifit==''?Text('') : Container(
                  alignment: Alignment.topLeft,
                    padding: EdgeInsets.only(left: 15.0),
                    child:Text(
                          'Benifits:',
